...
<header>
    ...
    $menuItems = [
        ...
        ['label' => 'Товар', 'url' => ['/tovar/index'], 'options' => ['class' => 'bold-white-text']],
        ['label' => 'Автомобили', 'url' => ['/avtomobili/index'], 'options' => ['class' => 'bold-white-text']],
        ['label' => 'Диспетчерская', 'url' => ['/dispet/index'], 'options' => ['class' => 'bold-white-text']],
        ['label' => 'Гараж', 'url' => ['/garaj/index'], 'options' => ['class' => 'bold-white-text']],
        ['label' => 'Маршрут', 'url' => ['/marshrut/index'], 'options' => ['class' => 'bold-white-text']],
        ['label' => 'Водители', 'url' => ['/voditeli/index'], 'options' => ['class' => 'bold-white-text']],
    ];
