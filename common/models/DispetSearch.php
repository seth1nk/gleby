...
class DispetSearch extends Dispet
{
    ...
    public function rules()
    {
        return [
            [['Код_авто'], 'integer'],
            [['Время_прибытия', 'Время_отбытия', 'Код_водителя', 'Путевка', 'Товар'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'Время_прибытия', $this->Время_прибытия])
            ...
            ->andFilterWhere(['like', 'Код_водителя', $this->Код_водителя])
            ->andFilterWhere(['like', 'Путевка', $this->Путевка])
            ->andFilterWhere(['like', 'Товар', $this->Товар]);
